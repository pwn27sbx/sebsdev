        ...
        <div className="min-h-screen bg-[#f5f5f5] dark:bg-[#0a0a0a] flex items-center justify-center text-center px-6 transition-colors duration-500">
          <div>
            ...
            <button onClick={() => window.location.reload()}
              className="mt-8 px-8 py-4 bg-[#00A889] text-white rounded-full font-anton text-sm uppercase tracking-widest hover:bg-[#00c5a1] transition-[background-color] duration-300"
            >
              Refresh Page
            </button>
          </div>
