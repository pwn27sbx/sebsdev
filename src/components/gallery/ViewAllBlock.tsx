    ...
    >
      <div className="group w-full max-w-5xl flex flex-col pointer-events-auto relative">
        ...
        >
          ...
          <div className={`absolute top-0 w-full h-px bg-gradient-to-r from-transparent via-[#333] dark:via-[#444] group-hover:via-[#00A889] to-transparent transition-colors duration-500 ${intermittent ? 'via-[#00A889]' : ''}`}></div>
          <div className={`absolute bottom-0 w-full h-px bg-gradient-to-r from-transparent via-[#333] dark:via-[#444] group-hover:via-[#00A889] to-transparent transition-colors duration-500 ${intermittent ? 'via-[#00A889]' : ''}`}></div>
          
          {/* Giant Typography Link */}
          <div className="relative z-10 flex flex-col items-center text-center">
            <h3 className={`font-anton text-[9vw] sm:text-[7vw] md:text-[6vw] lg:text-[7vw] uppercase tracking-tighter leading-none whitespace-nowrap cursor-crosshair text-[#111] dark:text-white [text-shadow:4px_0_#00A889,-4px_0_#FF2A6D] group-hover:[text-shadow:none] group-hover:text-transparent group-hover:[-webkit-text-stroke:2px_#333] dark:group-hover:[-webkit-text-stroke:2px_#fff] transition-all duration-200 ${intermittent ? '[text-shadow:none] text-transparent [-webkit-text-stroke:2px_#333] dark:[-webkit-text-stroke:2px_#fff]' : ''}`}>
            ...
            <div className="mt-4 md:mt-0 md:absolute md:-bottom-10 font-mono text-[#00A889] opacity-100 translate-y-0 md:opacity-0 md:translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 text-[10px] sm:text-sm tracking-widest flex items-center gap-4 whitespace-nowrap">
