      ...
      <div className="group w-full max-w-5xl flex flex-col pointer-events-auto relative">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <h3 className={`font-anton text-[9vw] sm:text-[7vw] md:text-[6vw] lg:text-[7vw] uppercase tracking-tighter leading-none whitespace-nowrap cursor-crosshair text-[#111] dark:text-white [text-shadow:4px_0_var(--color-secondary),-4px_0_var(--color-primary)] group-hover:[text-shadow:none] group-hover:text-transparent group-hover:[-webkit-text-stroke:2px_#333] dark:group-hover:[-webkit-text-stroke:2px_#fff] transition-all duration-200 [.immersion-full_&]:text-accent [.immersion-full_&]:[-webkit-text-stroke:1px_var(--color-primary)] [.immersion-full_&]:[text-shadow:0_0_12px_var(--color-accent),5px_0_var(--color-secondary),-5px_0_var(--color-primary)] [.immersion-full_&]:group-hover:[text-shadow:none] [.immersion-full_&]:group-hover:text-transparent [.immersion-full_&]:group-hover:[-webkit-text-stroke:2px_var(--color-secondary)] ${intermittent ? '[text-shadow:none] text-transparent [-webkit-text-stroke:2px_#333] dark:[-webkit-text-stroke:2px_#fff]' : ''}`}>
