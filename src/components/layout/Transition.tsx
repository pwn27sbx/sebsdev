  ...
  return (
    <motion.div className="relative w-full h-full">
      ...
      <motion.div
        ...
        className="fixed top-0 left-0 w-full h-screen bg-secondary z-[999] origin-top pointer-events-none"
      />
      ...
      <motion.div
        ...
        className="fixed top-0 left-0 w-full h-screen bg-primary z-[998] origin-top pointer-events-none"
      />
      ...
      <motion.div
        ...
        className="fixed top-0 left-0 w-full h-screen bg-[var(--color-bg-dark)] z-[997] origin-top pointer-events-none flex flex-col items-center justify-center overflow-hidden"
      >
        {/* Engineering Grid */}
        ...
        {/* Cyberpunk Text */}
        <h1 className="font-anton text-4xl sm:text-6xl md:text-8xl text-transparent [-webkit-text-stroke:2px_var(--color-primary)] uppercase tracking-widest z-10 opacity-90 mix-blend-screen animate-pulse">
          SYSTEM_OVERRIDE
        </h1>
        
        {/* Scanline */}
        <div className="absolute top-1/2 left-0 w-full h-[2px] bg-secondary shadow-[0_0_20px_var(--color-secondary)] animate-bounce" style={{ animationDuration: '2s' }} />
      </motion.div>
      ...
      <motion.div
        ...
        className="fixed top-[70%] left-0 w-full h-4 bg-secondary z-[1000] origin-left pointer-events-none"
      />
    </motion.div>
  );
};
