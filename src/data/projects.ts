...
const ALL_PROJECTS: MasterProject[] = [
  {
    ...
    title: "Nexus",
    year: "2024",
    link: "https://nexusallinone.vercel.app/",
    img: "/img/9.webp",
  ...
  },
  {
    ...
    archive: {
      id: "01",
      category: "Productivity Tool / Web Application",
      title: "MINI-EXCEL",
    },
    gallery: {
      id: "08",
  ...
  },
  {
    ...
    archive: {
      id: "02",
      category: "SaaS Interface / Visual Programming",
  ...
  },
  {
    ...
    archive: {
      id: "03",
      category: "E-commerce Search Engine",
      title: "FACETED FILTERS UI",
    },
    gallery: {
      id: "12",
      category: "FULLSTACK",
...
export const GALLERY_PROJECTS: GalleryProject[] = ALL_PROJECTS.filter(
  (p) => p.gallery,
)
  .map((p) => {
    const g = p.gallery!;
    return {
      ...
      title: g.title,
      year: p.year,
      link: p.link.startsWith("/")
        ? import.meta.env.BASE_URL + p.link.replace(/^\//, "")
        : p.link,
    };
  })
  .sort((a, b) => a.id.localeCompare(b.id));

export const ARCHIVE_PROJECTS: ArchiveProject[] = ALL_PROJECTS.filter(
  (p) => p.archive,
)
  .map((p) => {
    const a = p.archive!;
    return {
      ...
      link: p.link.startsWith("/")
        ...
        : p.link,
      video: a.video
        ? import.meta.env.BASE_URL + a.video.replace(/^\//, "")
        : undefined,
    };
  })
  .sort((a, b) => a.id.localeCompare(b.id));
